<template>
  <div :class="styles.container">
    ...
    <main id="main1" :class="styles.main">
      ...
      <div class="container">
        <p style="margin-top: 100px">Do you have difficulty reading or understanding English?</p>
...
const keyDownHandler = (e) => {
  if (['1', '2', '3', '4', '5', '6', '7'].includes(e.key)) {
    cookies.set('FR_difficulty', e.key, { maxAge: 60 * 6 * 24 })
    document.getElementById('main1').classList.add('blackbg')
    setTimeout(() => {
      router.push('instructions26')
    }, 50)
  }
}
