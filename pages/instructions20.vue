  ...
  <div :class="styles.container">
    ...
    <main id="main1" :class="styles.main">
      ...
      <p>
        ...
        Your task will be to count the exact number of letters J, K, L, M that appear throughout the task. <br/><br/>

        At the end of the task, you will need to indicate how many times each of the letters J, K, L, M appeared. <br /><br/>
