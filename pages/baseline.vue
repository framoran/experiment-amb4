<template>
  <div :class="styles.container">
    ...
    <main v-if="showInstruction" id="main1" :class="styles.main">
      ...
      <p :class="styles.m1">
        During the next 8 minutes, your resting physiological activity will be measured.
      </p>
      <p>During this time, you will watch a documentary film.</p>
      <p>Important note: Please try to maintain the same body position throughout the entire experiment.</p>
    ...
    <main v-else id="main2" :class="[styles.main, styles.video]">
      <video id="myVideo" width="100%" height="100%" controls>
        <source src="../public/movie1.mp4" type="video/mp4" />
