...
const itiTime = [2000, 5000, 3000, 3000, 4000]
const fixationCrossTime = 1000
const list = ["FGD", "LEKNMS", "LK", "QWSCVFR",  "WV"]
const displayTime = [1000, 2000, 4000, 2000, 4000]
let i = 0
...
const trial = () => {
  ...
  if (i === list.length) {
    setTimeout(() => router.push('/instructions8'), 2000)
  } else {
