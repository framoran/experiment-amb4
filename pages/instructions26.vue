<template>
  <div :class="styles.container">
    ...
    <main id="main1" :class="styles.main">
      ...
      <div class="container">
        <p style="margin-top: 100px">What is your native language?</p>

        <p style="margin-top: 100px">
          1 = English&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;2 = Spanish&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;3 = French&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;4 = Portuguese&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;5 = German&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;6 = Italian&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;7 = Other
        </p>
...
const keyDownHandler = (e) => {
  if (['1', '2', '3', '4', '5', '6', '7'].includes(e.key)) {
    cookies.set('language', e.key, { maxAge: 60 * 6 * 24 })
    document.getElementById('main1').classList.add('blackbg')
    setTimeout(() => {
      router.push('instructions27')
    }, 50)
  }
}
